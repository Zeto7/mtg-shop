...
export const ChooseProductForm: React.FC<Props> = ({ className, imageUrl, name, items, price, onSubmit }) => {
  ...
  return (
    <div className={cn(className, 'flex flex-1')}>
        ...
        <div className="w-[490px] bg-[#FCFCFC] p-7">
            ...
            <Button className="h-[55px] px-10 text-base rounded-[18px] w-full mt-10">Добавить в корзину за {price} Br</Button>
        </div>
    </div>
  )
};   