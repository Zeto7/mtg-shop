    ...
    export const ProductForm: React.FC<Props> = ({ className, onSubmit: _onSubmit, product }) => {
        ...
        if(isKitForm) {
            return <ChooseKitForm imageUrl={product.imageUrl} name={product.name} additionals={product.additionals} items={product.items} onSubmit={onSubmit} description={product.description || ''} />
        } 
        return <ChooseProductForm imageUrl={product.imageUrl} name={product.name} price={firsItem.price} onSubmit={onSubmitProduct} description={product.description || ''} />
    };